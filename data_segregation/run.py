...
if __name__ == "__main__":
    ...
    parser.add_argument("--artifact_name_feature", type=str,required=True)
    parser.add_argument("--artifact_name_target", type=str, required=True)
...
# Run the script
    # mlflow run . -P artifact_name_feature="clean_features:latest" \
